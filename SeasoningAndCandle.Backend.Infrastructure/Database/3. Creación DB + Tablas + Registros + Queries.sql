 -- >>>>>>>>> Creación de la DB <<<<<<<<<<< --
	...
	-- Tuplas de Users --
	INSERT INTO USERS (FirstName, LastName, Phone, Email, Password, IsActive, CreatedAt, Address)
		VALUES ('Pepito Alejandro', 'Perez de la cruz', '3021233345', 'pepitoperez@gmail.com', '123', 1, GETUTCDATE(), 'cll 4');
	INSERT INTO USERS (FirstName, LastName, Phone, Email, Password, IsActive, CreatedAt, Address)
		VALUES ('Juanito', 'Alimaña', '3121233341', 'juanitoalimana@gmail.com', '1234', 0, GETUTCDATE(), 'cll 5');
	INSERT INTO USERS (FirstName, LastName, Phone, Email, Password, IsActive, CreatedAt, Address)
		VALUES ('Rosario', 'Tijeras', '3322213345', 'rosariotijeras@gmail.com', '12345', 1, GETUTCDATE(), 'cll 8');
	...
	INSERT INTO Categories (Code, Name, Description) VALUES ('0b39ef25-eb44-476b-8747-7d365b09196c', 'Carnes', '¡Carnes en todas sus formas y de la mejor calidad!');
	INSERT INTO Categories (Code, Name, Description) VALUES ('f349f80c-4bc0-434e-bd66-4a606f80120f', 'Comida rapida', '¡Lo mejor en comida rápida para toda la familia!');
	INSERT INTO Categories (Code, Name, Description) VALUES ('79009137-3b00-46a6-9a1b-b8e16868b125', 'Corrientazo', '¡En infantable platillo colombiano!');
